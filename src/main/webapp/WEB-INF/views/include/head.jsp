...
<head>
    ...
    <%--lightbox--%>
    <link rel="stylesheet" href="${ path }/resources/bower_components/lightbox/css/lightbox.css">
    <!-- Theme style -->
    ...
    <%--fileupload--%>
    <link rel="stylesheet" media="screen" href="${ path }/resources/bower_components/fileupload/css/jasny-bootstrap.min.css">
