	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content container-fluid">
				...
				<form role="form" id="updateForm" method="post" action="${ path }/board/paging/search/update">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<input type="hidden" name="perPageNum" value="${searchCri.perPageNum}">
							<input type="hidden" name="searchType" value="${searchCri.searchType}">
							<input type="hidden" name="keyword" value="${searchCri.keyword}">
...
<script>
	...
	$(document).ready(function () {
		...
		$(".listBtn").on("click", function() {
			self.location = "/board/paging/search/list?page=${searchCri.page}" 
